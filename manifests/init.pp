...
class influxdb_relay (
  ...
  Hash[String,Hash[String,Any]]    $http_backends     = $::influxdb_relay::params::http_backends,
  String                           $udp_name          = "${::fqdn}-udp",
  String                           $udp_bind_address  = $::ipaddress,
  Integer                          $udp_bind_port     = 9096,
  Integer                          $udp_read_buffer   = 0,
  String                           $precision         = 'n',
  Hash[String,Hash[String,Any]]    $udp_backends      = $::influxdb_relay::params::udp_backends,
